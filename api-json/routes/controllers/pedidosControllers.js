...
const ventasData = require('../../data/ventaData'); // Importamos el módulo ventasData
...
const createPedido = async (req, res) => {
    ...
    try {
        ...
        await ventasData.createVenta(numero_mesa, productos, total_venta, estado, fechaHoraActual, email_mesero);
